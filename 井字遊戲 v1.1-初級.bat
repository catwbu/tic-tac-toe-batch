...
:w69
if not "%num6%"=="○" goto w78
if "%w69%"=="1" goto w78
if "%num6%"=="%num9%" (
if "%num3%"=="%zzz%" set w69=1&goto w3
)
:w78
if not "%num7%"=="○" goto w89
if "%w78%"=="1" goto w79
if "%num7%"=="%num8%" (
